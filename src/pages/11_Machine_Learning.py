...
with col_viz:
    ...
    fig_pipe.update_layout(title="Pipeline: Do Dado à Previsão", height=310,
        paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)",
        font_color="#d9d9d9", margin=dict(l=10, r=10, t=45, b=10))
...
with tab1:
    ...
    with col_g1:
        ...
        fig_reg.update_layout(height=300, showlegend=False,
    ...
    with col_g2:
        ...
        fig_nps.update_layout( height=300,
    ...
    insight_box("O Norte demora <strong>2,5× mais</strong> que o Sudeste para receber um pedido. Cada dia a mais no prazo reduz a nota — e a regressão linear vai capturar exatamente essa relação, gerando um coeficiente interpretável: <em>'cada dia adicional equivale a X pontos a menos no review score esperado'</em>.")
...
with tab2:
    ...
    with col_c1:
        ...
        fig_cat.update_layout(height=320, showlegend=False,
    ...
    with col_c2:
        ...
        fig_mat.update_layout(height=320,
...
fig_impact.update_layout(height=340, showlegend=False,
...
proposta_box("O ponto de partida recomendado é a <strong>Regressão Linear de Prazo</strong> — maior impacto direto no NPS, dados já disponíveis no projeto e resultado interpretável para qualquer área. Em paralelo, a <strong>Classificação de Categorias</strong> endereça o crescimento estratégico. O notebook de pesquisa com o código completo está em <code>notebooks/Gustavo/ml_modelo_preditivo_classificacao.ipynb</code>.")
